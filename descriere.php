...
<body>
    ...
    <div style="margin-left:25%;padding:1px 16px;height:1000px;">
        <h2>Descriete in citeva propozitii?</h2>

        <p1>Am facut liceul in localitatea mea Stefanesti, rnul Floresti. Dupa care, am inceput studiile la Universitatea Tehnica din Moldova, fiind la moment studenta in anul II, la facultatea Informatica Aplicata.</p1>
    </div>
